...
define([
    ...
    $.widget('mage.cleverBlockMage', {
        ...
        initCarouselVertical: function(id) {
            ...
            require(["CleverSoft_CleverProduct/js/jquery.bxslider"], (function () {
            ...
            seft.container.find('.widget-tabs a').each(function(){
                ...
                $(tab).on('click', function(e){
                    ...
                    var type = $(this).attr('data-type'),
                        ...
                        addtolinks_position = $(this).attr('data-addtolinks_position'),
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            addtolinks_position: addtolinks_position,
        ...
        initCarouselElement: function (config) {
            ...
            this.container.find('.owl-carousel').each(function () {
                ...
                if(config.equalHeight) {
                    $(div).attr('data-mage-init', JSON.stringify({'equalHeight': {'target': ' .owl-item'}}));
                    setTimeout(function(){ $(div).trigger('contentUpdated');}, 1500);
                }
