...
class Generator extends \Magento\Framework\Model\AbstractModel{
    ...
    public function __construct(
        ...
        \CleverSoft\Base\Model\Config\Backend\Resolver $resolver,
...
//        $rootPath = $this->_directoryList->getPath('app').'/design/'.$themeData['theme_path'].'/'.'CleverSoft_Base/templates/cleversoft/css/' . $design . '.phtml';
