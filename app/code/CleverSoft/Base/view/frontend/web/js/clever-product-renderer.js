    ...
    $.widget('mage.cleverInnerZoom', {
        ...
        _create: function(){
            ...
            $(image_obj).each(function() {
                ...
                var image_zoom = $('a', subject).attr('href'); // Get the large image.
                var image_zoom_w = 0;
                var image_zoom_h = 0;

                var image_zoom_obj = new Image() ;
                $(image_zoom_obj).one('load', function() {
    ...
    $.widget('mage.cleverSwatchRenderer', $.mage.SwatchRenderer, {
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            ...
            if (isProductViewExist) {
                ...
                context.find('.product-image-photo').attr('src',justAnImage.finalImg).attr('data-src',justAnImage.finalImg).waitForImages({
                    finished: function() {
                        // ...
                    },
                    each: function() {
