...
namespace CleverSoft\CleverQuickView\Controller\Product;
...
class View extends \Magento\Catalog\Controller\Product
{
    ...
    public function execute()
    {
        ...
        // Render page
        try {
            $page = $this->resultPageFactory->create(false, ['isIsolated' => true, 'template'=>'CleverSoft_CleverQuickView::blank.phtml'] );
