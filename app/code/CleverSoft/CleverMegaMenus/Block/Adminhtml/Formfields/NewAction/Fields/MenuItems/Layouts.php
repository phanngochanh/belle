    ...
    public function getImageHtmlPart($name,$placeholder,$label,$val,$type,$recommend = false,$style){
        ...
        <div class="menu-item-field row type__image field__'.$name.'" '.$style.'>
            ...
            <div class="col-xs-8">
                ...
                <button class="content-btn content-col-image"  onclick="MediabrowserUtility.openDialog(\''.$this->getUrl('cms/wysiwyg_images/index').'target_element_id/'.$unique.'\',\'\',\'\',\'\',{closed:\''.__('Closed').'\'})">
                    '. $label.'
                </button>
