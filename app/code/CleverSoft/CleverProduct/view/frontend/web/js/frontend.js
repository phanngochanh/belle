...
define(['jquery', 'jquery/ui','domReady',"jQueryLibMin","CleverSoft_CleverProduct/js/jquery.jcountdown.min","CleverSoft_CleverProduct/js/jquery.bxslider"], function($, ui,domReady) {
    'use strict';
